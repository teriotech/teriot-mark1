...
export default function HomePage() {
  return (
    <main className="overflow-hidden mobile-zoom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="flex justify-center">
              <Image
                ...
                width={600}
                height={400}
                className="rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 w-full h-auto"
              />
            </div>
