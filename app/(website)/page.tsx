...
export default function HomePage() {
  ...
  // Efek untuk memberikan efek zoom out 75% di perangkat Mobile
  useEffect(() => {
    const enforceMobileZoom = () => {
      const isMobile = 
      ...
      if (isMobile) {
        ...
        // Mengatur initial-scale ke 0.75 untuk efek zoom out 75% dengan lebar menyesuaikan device
        viewportMeta.setAttribute('content', 'width=device-width, initial-scale=0.75, maximum-scale=3.0, user-scalable=yes');
        
        // Fallback menggunakan CSS zoom untuk memastikan efek berjalan di semua browser mobile
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-5 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 md:gap-8 relative">
            ...
            <div className="group relative bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="text-5xl font-extrabold text-blue-600/20 mb-4">01</div>
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Sensor & Device</h3>
            ...
            {/* STEP 2 */}
            <div className="group relative bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="text-5xl font-extrabold text-blue-600/20 mb-4">02</div>
              <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-blue-600 transition-colors">
                <i className="ri-router-line text-3xl text-blue-600 group-hover:text-white"></i>
              </div>
              <h3 className="text-xl font-bold text-slate-900 mb-3">Gateway IoT</h3>
              <p className="text-slate-600 leading-relaxed">
            ...
            {/* STEP 3 */}
            <div className="group relative bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="text-5xl font-extrabold text-blue-600/20 mb-4">03</div>
              <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-blue-600 transition-colors">
                <i className="ri-server-line text-3xl text-blue-600 group-hover:text-white"></i>
              </div>
              <h3 className="text-xl font-bold text-slate-900 mb-3">Cloud Platform</h3>
              <p className="text-slate-600 leading-relaxed">
            ...
            {/* STEP 4 */}
            <div className="group relative bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="text-5xl font-extrabold text-blue-600/20 mb-4">04</div>
              <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-blue-600 transition-colors">
                <i className="ri-line-chart-line text-3xl text-blue-600 group-hover:text-white"></i>
              </div>
              <h3 className="text-xl font-bold text-slate-900 mb-3">Dashboard & Alert</h3>
              <p className="text-slate-600 leading-relaxed">
            ...
            {/* STEP 5 */}
            <div className="group relative bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="text-5xl font-extrabold text-blue-600/20 mb-4">05</div>
              <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-blue-600 transition-colors">
                <i className="ri-ai-generate text-3xl text-blue-600 group-hover:text-white"></i>
              </div>
              <h3 className="text-xl font-bold text-slate-900 mb-3">AI Assistant & Summary</h3>
              <p className="text-slate-600 leading-relaxed">
              ...
              <div className="ai-phone relative w-[340px] h-[650px] bg-slate-900 rounded-[3rem] p-3 shadow-2xl">
                ...
                <div className="h-full bg-slate-50 rounded-[2.5rem] overflow-hidden">
                  ...
                  <div className="bg-blue-600 text-white px-5 py-4 flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold">TeriotBot AI</div>
                    ...
                    <div className="chat-msg bot-summary flex justify-start">
                      <div className="bg-white border border-slate-200 px-4 py-4 rounded-2xl shadow-sm max-w-[95%]">
                        ...
                        <div className="space-y-2 text-sm text-slate-600 mb-4">
                          <div>
                            Produksi Total:
                            <span className="font-semibold text-slate-900">{" "}128.450 Unit</span>
                          </div>
                          <div>
                            OEE Rata-rata:
                        ...
                        <div className="grid grid-cols-3 gap-2 mb-3">
                          ...
                          <div className="bg-red-50 rounded-xl p-2 text-center">
                            ...
                            <div className="font-bold text-red-600">1.8%</div>
                          </div>
                        </div>
        ...
        <div className="container mx-auto px-5 md:px-6">
          ...
          <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm p-8 md:p-10 mb-12">
            <div className="grid md:grid-cols-3 gap-8 items-center">
              <div className="text-center">
                ...
                <h3 className="font-bold text-slate-900 text-xl mb-2">Industrial IoT</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-slate-900 text-xl mb-2">ERP Enterprise</h3>
                <p className="text-slate-600">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <div className="group bg-white p-7 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="font-bold text-slate-900 mb-3">CRM</h4>
            ...
            <div className="group bg-white p-7 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="font-bold text-slate-900 mb-3">Sales & Purchasing</h4>
              <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="group bg-white p-7 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="font-bold text-slate-900 mb-3">HR & Payroll</h4>
              <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="group bg-white p-7 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="font-bold text-slate-900 mb-3">SHEE System</h4>
              <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="group bg-white p-7 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="font-bold text-slate-900 mb-3">Warehouse Management</h4>
              <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="group bg-white p-7 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="font-bold text-slate-900 mb-3">Asset Management</h4>
              <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="group bg-white p-7 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="font-bold text-slate-900 mb-3">Stock Taking</h4>
              <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="group bg-white p-7 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="font-bold text-slate-900 mb-3">Finance & Accounting</h4>
              <p className="text-slate-600 text-sm leading-relaxed">
        ...
        <div className="container mx-auto px-5 md:px-6">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-5 gap-6 mb-16">
            <div className="bg-white border border-slate-100 rounded-[2rem] p-6 shadow-sm hover:shadow-xl transition">
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">Time Based Maintenance</h3>
            ...
            <div className="bg-white border border-slate-100 rounded-[2rem] p-6 shadow-sm hover:shadow-xl transition">
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">Predictive Maintenance</h3>
              <p className="text-sm text-slate-600">
            ...
            <div className="bg-white border border-slate-100 rounded-[2rem] p-6 shadow-sm hover:shadow-xl transition">
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">Auto Scheduling</h3>
              <p className="text-sm text-slate-600">
            ...
            <div className="bg-white border border-slate-100 rounded-[2rem] p-6 shadow-sm hover:shadow-xl transition">
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">Sparepart Ready</h3>
              <p className="text-sm text-slate-600">
            ...
            <div className="bg-white border border-slate-100 rounded-[2rem] p-6 shadow-sm hover:shadow-xl transition">
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">Cost Planning</h3>
              <p className="text-sm text-slate-600">
          ...
          <div className="bg-slate-50 rounded-[2.5rem] p-8 md:p-12 border border-slate-100">
            ...
            <div className="workflow-grid grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-[2rem] p-6 shadow-sm">
                ...
                <h4 className="font-bold text-slate-900 mb-3">Sensor Menangkap Kondisi Mesin</h4>
              ...
              <div className="bg-white rounded-[2rem] p-6 shadow-sm">
                ...
                <h4 className="font-bold text-slate-900 mb-3">Data Processing</h4>
                <p className="text-slate-600 text-sm">
              ...
              <div className="bg-white rounded-[2rem] p-6 shadow-sm">
                ...
                <h4 className="font-bold text-slate-900 mb-3">Machine Classification</h4>
                <p className="text-slate-600 text-sm">
              ...
              <div className="bg-white rounded-[2rem] p-6 shadow-sm">
                ...
                <h4 className="font-bold text-slate-900 mb-3">Generate PM / CM Schedule</h4>
                <p className="text-slate-600 text-sm">
              ...
              <div className="bg-white rounded-[2rem] p-6 shadow-sm">
                ...
                <h4 className="font-bold text-slate-900 mb-3">Assign Job ke Teknisi</h4>
                <p className="text-slate-600 text-sm">
              ...
              <div className="bg-white rounded-[2rem] p-6 shadow-sm">
                ...
                <h4 className="font-bold text-slate-900 mb-3">QR Barcode Reporting</h4>
                <p className="text-slate-600 text-sm">
              ...
              <div className="bg-white rounded-[2rem] p-6 shadow-sm">
                ...
                <h4 className="font-bold text-slate-900 mb-3">Recorded PM / CM History</h4>
                <p className="text-slate-600 text-sm">
              ...
              <div className="workflow-result bg-gradient-to-br from-blue-600 to-blue-700 rounded-[2rem] p-6 text-white flex flex-col">
                <div className="text-white/30 font-black text-5xl mb-4">RESULT</div>
                <h4 className="font-bold text-xl mb-3">Smart Maintenance Ecosystem</h4>
      ...
      <section
        ...
        className="py-16 md:py-24 bg-slate-50 overflow-hidden relative"
      >
        <div className="container mx-auto px-5 md:px-6">
          {/* Header */}
          <div className="max-w-4xl mx-auto text-center mb-14 md:mb-20">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="group bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 text-center">
              ...
              <div className="text-4xl md:text-5xl font-black text-slate-900 mb-2">12+</div>
              <div className="font-bold text-slate-900 mb-2">Perusahaan Terlayani</div>
              <p className="text-sm text-slate-500">Berbagai perusahaan nasional dan multinasional.</p>
            </div>
            ...
            <div className="group bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 text-center">
              ...
              <div className="text-4xl md:text-5xl font-black text-slate-900 mb-2">60+</div>
              <div className="font-bold text-slate-900 mb-2">Logger Terpasang</div>
              <p className="text-sm text-slate-500">Monitoring real-time pada mesin dan utilitas industri.</p>
            </div>
            ...
            <div className="group bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 text-center">
              ...
              <div className="font-bold text-slate-900 mb-2">Customer Support</div>
              <p className="text-sm text-slate-500">Tim support siap membantu kapan pun dibutuhkan.</p>
            </div>
            ...
            <div className="group bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 text-center">
              ...
              <div className="text-4xl md:text-5xl font-black text-slate-900 mb-2">4+</div>
              <div className="font-bold text-slate-900 mb-2">Kawasan Industri</div>
              <p className="text-sm text-slate-500">Implementasi solusi digital di berbagai kawasan industri.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-5 md:px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm p-8 hover:shadow-xl transition">
              ...
              <div className="mb-8">
                <h4 className="font-bold text-green-600 mb-4">Keunggulan</h4>
                <div className="space-y-3">
                  <div className="flex gap-3">
                    <i className="ri-checkbox-circle-fill text-green-500"></i>
                    <span className="text-slate-600">Kepemilikan sistem sepenuhnya.</span>
                  </div>
                  <div className="flex gap-3">
                    <i className="ri-checkbox-circle-fill text-green-500"></i>
                    <span className="text-slate-600">Data tersimpan di lingkungan internal perusahaan.</span>
                  </div>
                  <div className="flex gap-3">
                    <i className="ri-checkbox-circle-fill text-green-500"></i>
                    <span className="text-slate-600">Tidak ada biaya langganan bulanan.</span>
                  </div>
                  <div className="flex gap-3">
                    <i className="ri-checkbox-circle-fill text-green-500"></i>
                    <span className="text-slate-600">Fleksibilitas kustomisasi lebih tinggi.</span>
                  </div>
                </div>
              </div>

              <div>
                <h4 className="font-bold text-amber-600 mb-4">Pertimbangan</h4>
                <div className="space-y-3">
                  <div className="flex gap-3">
                    <i className="ri-information-line text-amber-500"></i>
                    <span className="text-slate-600">Investasi awal lebih besar.</span>
                  </div>
                  <div className="flex gap-3">
                    <i className="ri-information-line text-amber-500"></i>
                    <span className="text-slate-600">Membutuhkan infrastruktur server dan IT internal.</span>
                  </div>
                  <div className="flex gap-3">
                    <i className="ri-information-line text-amber-500"></i>
                    <span className="text-slate-600">Pengelolaan sistem menjadi tanggung jawab perusahaan.</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-[2rem] shadow-xl p-8 text-white">
              ...
              <div className="mb-8">
                <h4 className="font-bold text-white mb-4">Keunggulan</h4>
                <div className="space-y-3">
                  <div className="flex gap-3">
                    <i className="ri-checkbox-circle-fill"></i>
                    <span>Investasi awal lebih rendah.</span>
                  </div>
                  <div className="flex gap-3">
                    <i className="ri-checkbox-circle-fill"></i>
                    <span>Update dan maintenance ditangani TERIOT.</span>
                  </div>
                  <div className="flex gap-3">
                    <i className="ri-checkbox-circle-fill"></i>
                    <span>Implementasi lebih cepat.</span>
                  </div>
                  <div className="flex gap-3">
                    <i className="ri-checkbox-circle-fill"></i>
                    <span>Mudah dikembangkan sesuai pertumbuhan bisnis.</span>
                  </div>
                </div>
              </div>

              <div>
                <h4 className="font-bold text-blue-100 mb-4">Pertimbangan</h4>
                <div className="space-y-3">
                  <div className="flex gap-3">
                    <i className="ri-information-line"></i>
                    <span>Memiliki biaya langganan berkala.</span>
                  </div>
                  <div className="flex gap-3">
                    <i className="ri-information-line"></i>
                    <span>Bergantung pada koneksi internet untuk layanan cloud.</span>
                  </div>
                </div>
              </div>
            </div>
