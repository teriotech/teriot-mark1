  ...
  return (
    <html lang="en">
      ...
      <body>
            ...
            <nav id="navbar" className="navbar">
              <ul>
                ...
                <li className="dropdown">
                  ...
                  <ul>
                    <li>
                      <Link href="/product_GMES">Industrial IOT</Link>
                    </li>
                    <li>
                      <Link href="/product_GMMS">Maintenance Smart</Link>
                    </li>
                    <li>
                      <Link href="/product_GERP">ERP Digital</Link>
                    </li>
                    <li>
                      <Link href="/product_RPA">RPA</Link>
                    </li>
                  </ul>
                </li>
        ...
        {/* ===== Custom Script: Auto Close Mobile Menu on Link Click ===== */}
          ...
          {`
            if (typeof window !== 'undefined') {
              document.addEventListener('click', function(e) {
                ...
                // Jika link berada di dalam navbar dan bukan tombol dropdown (href="#")
                if (target.closest('#navbar') && target.getAttribute('href') !== '#') {
